...
const problems = [
  'Lead আসে, follow-up হয় না',
  'Staff কাজ করছে কিনা বোঝা যায় না',
  'Customer message হারিয়ে যায়',
  'Sales data ছড়ানো',
  'Software আছে, opportunity নেই',
]

const pillars = [
  {
    title: 'System',
    body: 'CRM, Inbox, Pipeline, Automation, Reports - one connected operating room.',
    icon: Network,
  },
  {
    title: 'Opportunity',
  ...
  {
    title: 'Execution',
    body: 'NRE services and managed support for setup, recovery, and growth.',
    icon: Zap,
  },
]
  ...
  return (
    <main className="min-h-screen bg-[#070B12] text-white">
      <header className="border-b border-white/10">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 sm:px-6">
          <Link href="/unreal-bs" className="flex items-center gap-3">
            <Image src="/logo.png" alt="UNREAL BS" width={38} height={38} className="rounded-xl" priority />
            <span className="text-sm font-black tracking-wide">UNREAL BS</span>
          </Link>
          <nav className="hidden items-center gap-6 text-sm text-white/70 md:flex">
            <a href="#solution" className="hover:text-white">Solution</a>
            <a href="#price" className="hover:text-white">Founding Offer</a>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto grid max-w-6xl gap-10 px-4 py-16 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:py-24">
          <div className="flex flex-col justify-center">
            <p className="mb-4 text-sm font-bold uppercase tracking-[0.18em] text-[#00C875]">Let&apos;s Go High Level</p>
            <h1 className="max-w-3xl text-5xl font-black leading-tight sm:text-6xl">
              ...
              <span className="mt-4 block text-3xl text-[#D8B86A] sm:text-4xl">
                আপনি না থাকলেও Business থেমে যাবে না।
              </span>
            </h1>
            <p className="mt-6 max-w-2xl text-lg leading-8 text-white/75">
              Lead, staff, follow-up, sales and reports - সব এক connected business system-এ।
            </p>
            <p className="mt-3 max-w-2xl text-base text-white/60">
              Lead-Ready Business Portal + Opportunity Credit for Bangladesh founding clients.
            </p>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.06] p-4 shadow-2xl shadow-black/30 backdrop-blur">
            <div className="rounded-xl bg-[#10172A] p-5">
              ...
              <div className="mt-4 rounded-xl border border-[#00C875]/20 bg-[#00C875]/10 p-4">
                ...
                <p className="mt-1 text-sm text-white/70">Review 3 new opportunities before weekly settlement.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="solution" className="border-y border-white/10 bg-white/[0.03]">
        <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
          <div className="max-w-2xl">
            <h2 className="text-3xl font-black">One portal for system, opportunity, and execution.</h2>
      ...
      <section id="price" className="mx-auto grid max-w-6xl gap-8 px-4 py-16 sm:px-6 lg:grid-cols-[0.9fr_1.1fr]">
        <div>
          <h2 className="text-3xl font-black">Founding Membership</h2>
          <p className="mt-4 text-white/65">
            Built for the first 5-20 Bangladesh founding clients who want a lead-ready portal and managed onboarding.
          </p>
        </div>
        <div className="rounded-2xl border border-[#D8B86A]/30 bg-[#D8B86A]/10 p-6">
          ...
          <p className="mt-5 text-sm leading-6 text-white/65">
            ...
            Accepted opportunity weekly settlement-এ যাবে.
          </p>
        </div>
      </section>
      ...
      <section id="how" className="mx-auto max-w-6xl px-4 pb-20 sm:px-6">
        <div className="mb-8 flex items-end justify-between gap-4">
          <div>
            ...
            <p className="mt-3 text-white/65">From application to portal activation to weekly settlement.</p>
          </div>
