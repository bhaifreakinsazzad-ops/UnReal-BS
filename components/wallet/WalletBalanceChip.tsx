  ...
  return (
    <Card className="border-gray-200">
      <div className="flex items-center gap-2">
        ...
        <p className="text-sm font-bold text-gray-600">{isBn ? 'ওয়ালেট ব্যালেন্স' : 'Wallet Balance'}</p>
      </div>
      ...
      {error && (
        <p className="mt-1 text-xs text-red-500">
          {isBn ? 'আপনার ওয়ালেট ব্যালেন্স লোড করা যায়নি।' : 'Could not load your wallet balance.'}
        </p>
      )}
    </Card>
  )
